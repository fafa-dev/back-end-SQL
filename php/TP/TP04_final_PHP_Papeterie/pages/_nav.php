        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-secondary">
                    <a class="dropdown-item"<?php if ($page == 'prod_papeterie') {echo ' style="display:none"';} ?> href="/pages/prod_papeterie.php">Papeterie</a>
                    <a class="dropdown-item"<?php if ($page == 'prod_ecriture') {echo ' style="display:none"';} ?> href="/pages/prod_ecriture.php">Ecriture</a>
